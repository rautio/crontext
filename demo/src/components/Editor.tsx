  ...
  return (
    <div className="w-full flex flex-col">
      <input
        ...
        className="block p-4 border-2 rounded-lg sm:text-md bg-gray-700 border-gray-600 placeholder-gray-400 text-white focus:ring-indigo-500 focus:border-indigo-500"
      />
...
// w-full border p-4 bg-gray-700 border-gray-600 placeholder-gray-400 text-white rounded-lg focus:border-indigo-500 focus:ring-indigo-500
