...
export class AppHeader extends LitElement {
  render() {
    return html`
      <header class-name="flex pl-12 px-8 h-[60px] max-w-6xl m-auto">
        <div class-name="flex flex-grow">
          <a class-name="flex" href="/">
            <image
              ...
              height="32"
            />
            <span class-name="pl-2 font-bold text-2xl leading-[60px]">
              Crontext
            </span>
          </a>
        </div>
        <a href="https://github.com/rautio/crontext">
          <div class-name="flex leading-[60px] hover:text-sky-500">
            <span>Github</span>
            <span class-name="m-auto pl-2">
              <svg
                width="15"
                height="15"
                viewBox="0 0 15 15"
